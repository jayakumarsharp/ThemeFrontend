...
const CurrencyGrid = () => {
    ...
    const [currencyData, setCurrencyData] = useState({ name: '', code: '', country: '' });
    ...
    const columns = [
        ...
        { headerName: 'Country', field: 'country', sortable: true, filter: true },
        {
            headerName: 'Actions',
           field: '_id',
           cellRenderer: ActionsRenderer, flex: 1 
        },
    ];
    ...
    return (
        ...
        <DashboardLayout>
            ...
            <div className="ag-theme-alpine" style={{ height: 400, width: '100%' }}>
                <Button variant="contained" onClick={handleAdd} style={{ marginBottom: '10px' }}>Add Currency</Button>
                <AgGridReact
                    rowData={currencies}
                    columnDefs={columns}
                    pagination={true}
                ...
                <Dialog open={isDialogOpen} onClose={() => setIsDialogOpen(false)}>
                    ...
                    <DialogContent>
                        ...
                        <TextField
                            ...
                            onChange={(e) => setCurrencyData({ ...currencyData, country: e.target.value })}
                        />
                    </DialogContent>
                    <DialogActions>
