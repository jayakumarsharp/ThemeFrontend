        ...
        <ListItemText
          primary={
            <span className="listLabel">
              {label} {subtext && <span className="listSubtext">({subtext})</span>}
            </span>
          }
                    ...
                    <CardContent>
                      <List>
                        ...
                        {generateListItem({
                          ...
                          )} - ${toDecimalHundredths(quoteSummary?.summaryDetail?.dayHigh)}`,
                        })}
                        {generateListItem({
                          label: "52 Week Range",
                          subtext: "",
                    ...
                    <CardContent>
                      <List>
                        ...
                        {generateListItem({
                          ...
                          subtext: "",
                          text: toPercent(quoteSummary?.summaryDetail?.dividendYield),
                        })}
                        {generateListItem({
                          label: "Previous Ex-Date",
                          subtext: "",
                          text: toReadableDate(quoteSummary?.summaryDetail?.exDividendDate),
                        })}
                      </List>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      <List>
                        ...
                        {generateListItem({
                          ...
                          subtext: "",
                          text: quoteSummary?.defaultKeyStatistics?.enterpriseValue,
                        })}
                        {generateListItem({
                          label: "Shares Outstanding",
                          subtext: "",
                          text: quoteSummary?.defaultKeyStatistics?.sharesOutstanding,
                        })}
                        {generateListItem({
                          label: "Shares Held By Inst.",
                          subtext: "",
                          text: toPercent(
                            quoteSummary?.defaultKeyStatistics?.heldPercentInstitutions
                          ),
                        })}
                      </List>
                    </CardContent>
